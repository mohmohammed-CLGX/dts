                ...
                <asp:Panel ID="PanalAddNew" runat="server" GroupingText="Add New" Font-Size="XX-Small" Width="1000px">
                    <table style="width: 87%;">
                        <tr>
                            ...
                            <td>
                                <asp:Panel ID="Panel12" runat="server" GroupingText="Processing Type" Width="220px">
                            ...
                            <td>
                                <asp:Panel ID="Panel13" runat="server" GroupingText="File Type" Width="220px">
                            ...
                            <td>
                            <asp:Panel GroupingText="Expiration Date" Width="130px" Font-Size="X-Small" ID="Panel2" runat="server">
                                <asp:ImageButton ID="imgexdt" runat="server" Height="20px" ImageAlign="Middle"
                                    ImageUrl="~/App_Themes/calendar_icon.png" Width="20px" />
                                <asp:TextBox ID="txtexdt" runat="server" Font-Size="X-Small" MaxLength="10"
                                    Width="55px"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender4" runat="server" Enabled="True" PopupButtonID="imgexdt"
                                    TargetControlID="txtexdt" PopupPosition="Right">
                                </cc1:CalendarExtender>
                            <asp:RegularExpressionValidator ID="regexexdt" 
                                 runat="server" ErrorMessage="Please enter a date in mm-dd-yyyy format." 
                            ControlToValidate="txtexdt" Display="None" ValidationExpression="([1-9]|0[1-9]|1[012])([-]|[/])([1-9]|0[1-9]|[12][0-9]|3[01])([-]|[/])(19|20)\d\d"></asp:RegularExpressionValidator>
                            <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender8"
                                    runat="server" Enabled="True" TargetControlID="regexexdt">
                    </cc1:ValidatorCalloutExtender>   
                 </asp:Panel>
                            </td>
                        </tr>
                            ...
                            <td rowspan="2" colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td width="270px">
                                            <asp:Panel ID="PanelTitle" runat="server" GroupingText="Title" Width="360px" Style="margin-left: 0px">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td style="height: 30px" colspan="5" align="right">
                                    <br />
                ...
                <cc1:ModalPopupExtender ID="mpeconfirmnewdelete" runat="server" PopupControlID="Panelconfirmdelnew"
                 ...
                 <asp:Panel ID="Panel1" runat="server" GroupingText="Recently Added" Width="1000px"
                    Font-Size="X-Small" Height="390px" >
                      <div style="width: 950px; height: 380px; overflow: auto;">
